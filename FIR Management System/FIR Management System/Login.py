...
label_0 = Label(root, text="LOGIN",width=23,font=("Tahoma", 20,"bold"), background='#b1dee3',fg ="#152930")
label_0.place(x=50,y=270)

label_1 = Label(root, text="Username",width=13,font=("Courier New", 16,"bold"), background='#b1dee3')
...
label_2 = Label(root, text="Password",width=13,font=("Courier New", 16,"bold"), background='#b1dee3')
...
b = Button(root, text='Login',width=13,height=1,bg='#afa394',fg='black',background="#89C4F4",font=("Century Gothic", 16,"bold"), command=printtext).place(x=156,y=480)
Button(root, text='Quit',width=13,height=1,bg='#afa394',fg='black',background="#89C4F4",font=("Century Gothic", 16,"bold"),command=dest).place(x=156,y=530)
Button(root, text='Sign-up',width=13,height=1,bg='#afa394',background="#89C4F4",font=("Century Gothic", 16,"bold"),fg='black',command=sin).place(x=156,y=580)
root.mainloop()
